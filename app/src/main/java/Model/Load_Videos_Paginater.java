...
import Model.Teacher.Assign_Group_Adapter;
...
public class Load_Videos_Paginater implements View.OnClickListener{
    private YouTubePlayerSupportFragment youTubePlayerView_1;
    private Context context;
    private PullToLoadView pullToLoadView;
    private RecyclerView recyclerView;
    private Load_Videos_Adapter adapter;
    ...
    public Load_Videos_Paginater(Context c, PullToLoadView p, Videos ps, boolean con , View v){
        context = c;
        ...
        this.v = v;
        adapter = new Load_Videos_Adapter(context,video, recyclerView, ps , v);
