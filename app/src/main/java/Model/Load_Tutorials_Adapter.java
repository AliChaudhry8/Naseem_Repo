...
public class Load_Tutorials_Adapter extends RecyclerView.Adapter<Model.Load_Tutorials_Adapter.MyViewHolder1> {
    private YouTubePlayerSupportFragment youTubePlayerView_1;
    private Context context;
    private ArrayList<Video_BO> users;
    private RecyclerView recyclerView;
    private Tutorials activity;
    ...
    public Load_Tutorials_Adapter(Context c, ArrayList<Video_BO> u, RecyclerView rv, Tutorials a  , View v){
        context = c;
        recyclerView = rv;
        users = u;
        activity = a;
    ...
    @Override
    public Model.Load_Tutorials_Adapter.MyViewHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_tutorials_thumbnail, parent, false);
        final Model.Load_Tutorials_Adapter.MyViewHolder1 myViewHolder = new Model.Load_Tutorials_Adapter.MyViewHolder1(v);
    ...
    @Override
    public void onBindViewHolder(final Model.Load_Tutorials_Adapter.MyViewHolder1 holder,final int position) {
